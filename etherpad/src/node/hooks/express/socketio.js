...
var webaccess = require("../../../node/hooks/express/webaccess");
...
exports.expressCreateSocketioServer = function (hook_name, args, cb) {
  ...
  //FIXME  hooks.callAll("socketio", {"app": args.app, "io": io, "server": args.server});
  socketio.listen({"app": args.app, "io": io, "server": args.server})
